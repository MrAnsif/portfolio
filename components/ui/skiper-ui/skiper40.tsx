...
const Link001 = ({
  ...
  return (
    ...
    >
      {children}
      <svg
        className="ml-[0.3em] mt-[0em] size-[0.55em] translate-y-0.5 opacity-100 transition-all duration-300 [motion-reduce:transition-none] group-hover:rotate-45 group-hover:opacity-100 motion-reduce:transition-none"
        fill="none"
        viewBox="0 0 10 10"
