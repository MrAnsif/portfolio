...
const projects: Project[] = [
  {
    title: "AOT",
    description:
      "AOT is a full-stack MERN project that lets patients book appointments, doctors manage schedules, and admins oversee operations. It features JWT authentication, Razorpay payments, Cloudinary image storage, and an AI chatbot powered by the Gemini API.",
